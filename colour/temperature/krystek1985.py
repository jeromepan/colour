...
def uv_to_CCT_Krystek1985(uv, optimisation_parameters=None):
    ...
    *CIE UCS* colourspace *uv* chromaticity coordinates using *Krystek (1985)*
    ...
    Warnings
    --------
    *Krystek (1985)* does not give an analytical reverse transformation from
    correlated colour temperature :math:`T_{cp}` from given *CIE UCS*
    colourspace *uv* chromaticity coordinates, the current implementation
